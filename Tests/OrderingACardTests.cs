...
public class OrderingACardTests
{
    ...
    public async Task OprderingACard_WithExistingDataClient_ReturnsOk(string cardType, string paymentSystem)
    {
        var body = new List<ParametrOperation>()
        {
            new ParametrOperation { Identifier = "Product", Value = cardType },
            new ParametrOperation { Identifier = "ProgramType", Value = paymentSystem },
    ...
    public async Task OprderingACard_WithInvalidProductProgramType_ReturnsBadRequest(string cardType, string paymentSystem)
    {
        // Arrange
        var body = new List<ParametrOperation>()
        {
