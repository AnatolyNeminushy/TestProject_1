...
public class TransferToAnotherAccountTests
{
        ...
        string amount)
    {
        ...
        // Act
        var startOperationResponse =
            await restOperations.StartOperation("AccountTransfer", accessToken);
        var startOperationData =
            JsonDeserializer
                .DeserializeData<InfoOperation>(startOperationResponse.Content!);
        ...
        string currentAccount, string anotherAccount)
    {
        ...
        {
            new ParametrOperation {
                Identifier = "SourceAccount", Value = currentAccount },
            new ParametrOperation {
                Identifier = "ReceiverAccount", Value = anotherAccount },
            new ParametrOperation {
